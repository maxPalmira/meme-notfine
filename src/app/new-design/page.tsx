...
export default function NewDesign() {
  return (
    <div className="min-h-screen relative">
      {/* Gradient Background with Noise Filter - matching exact stops */}
      ...
      <div className="relative max-w-[1440px] mx-auto">
        ...
        <section className="relative px-6">
          ...
          <div className="relative mx-auto max-w-4xl">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <h1 className="text-black font-jua text-6xl text-center leading-tight">
                  THIS IS $NOTFINE!
                </h1>
              </div>
            </div>
          ...
          <div className="text-center max-w-2xl mx-auto mt-8">
            <p className="text-black font-jua text-base leading-relaxed">
          ...
          <div className="text-center mt-8">
            <div className="bg-[#FFF3DC] border-[7px] border-black rounded-[40px] px-8 py-4 inline-block mb-4">
          ...
          <div className="flex justify-center space-x-12 mb-16">
            <div className="w-24 h-24 bg-white border-[4px] border-black rounded-lg flex items-center justify-center hover:scale-110 transition-transform cursor-pointer">
              <Image
        ...
        <section className="relative py-16">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <Image
              ...
              width={605}
              height={268}
              className="absolute right-0 bottom-0 opacity-60"
            />
          </div>

          {/* Cloud Text */}
          <div className="relative z-10 text-center">
            <div className="bg-[#8B625B] rounded-full p-8 max-w-md mx-auto">
              <p className="text-[#FFF3DC] font-jua text-3xl leading-relaxed">
                chart down — not fine<br/>
                got rugged — not fine<br/>
                wallet drained — not fine<br/>
